...
## Q10.a. What is static method in php?

## Answer:

A static method in PHP is a method that belongs to a class itself, rather than an object created from that class. It can be called directly using the class name without creating an object.
...
## Q32. What is Output Buffering in PHP?

## Answer: 

Output buffering is a PHP feature that stores the output generated by a script in a temporary memory buffer instead of sending it immediately to the browser.
...
$output = ob_get_contents(); // Get stored output
...
## Q33. What is Call by Value in PHP?

**Answer:**

Call by Value means a copy of the variable is passed to the function.  
...
## Q34. What is Call by Reference in PHP?

**Answer:**

Call by Reference means the actual reference of the variable is passed to the function.  
Any changes made inside the function affect the original variable.

In PHP, we use `&` before the parameter.
...
## Q35. Difference between Call by Value and Call by Reference?

| Call by Value | Call by Reference |
|---|---|
| Passes a copy of the value | Passes the original reference |
| Original variable is not changed | Original variable can be changed |
| Default behavior in PHP | Uses `&` symbol |
